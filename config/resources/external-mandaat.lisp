...
(define-resource mandaat ()
  ...
  :properties `((:aantal-houders :number ,(s-prefix "mandaat:aantalHouders"))
                (:min-aantal-houders :number ,(s-prefix "lmb:minAantalHouders"))
                (:max-aantal-houders :number ,(s-prefix "lmb:maxAantalHouders")))
...
(define-resource mandataris-publication-status-code ()
  :class (s-prefix "lmb:MandatarisPublicationStatusCode")
  :properties `((:label :string ,(s-prefix "skos:prefLabel"))
